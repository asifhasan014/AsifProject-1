...
@Entity
@Table(name = "LEGAL_PETITIONERS")
public class Petitioner extends Auditable<String> implements Serializable {

    private static final long serialVersionUID = -2966705780575748088L;
